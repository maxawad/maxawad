...
I design, forge, and berth native apps, AI lookouts, and systems — rigged in Swift, TypeScript, Python, C++, and just enough CLI cantrips to lash stray chaos back to the bitts.

Berth: **San Francisco, CA** — when Karl peels back, making way: [maxawad.com](https://maxawad.com).
...
macOS Cmd+Tab only switches apps. WindowSwitch shows every window with live thumbnails so you land exactly where you left off. True MRU ordering, customizable shortcut, zero config. The Alt+Tab experience macOS keeps nursing barnacles on the backlog.
...
**MCP-native snack ordering — literal chips; GPUs on garnish watch**
...
<div align="center">
<sub>Most of my craft lies at anchor in private repos — treat this profile as the quarterdeck's signal book.</sub>
<br>
