...
Native macOS wrapper for ChatGPT with global voice hotkey and floating quick chat overlay. Hail with `Ctrl+Space` from any app to summon ChatGPT without losing way. Uses your existing ChatGPT account — GPT-4o, voice mode, the full Plus locker.
