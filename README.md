...
Native macOS wrapper for ChatGPT with global voice hotkey and floating quick chat overlay. Pipe `Ctrl+Space` from any deck-watch to summon ChatGPT without missing the watch bell's brass-bright knell. Uses your existing ChatGPT account — GPT-4o, live voice, the full Plus sea locker.
...
Heave round the dictation hawser, speak, and watch your words unfurl — offline-first, hawse-keen diction rail, private. Powered by NVIDIA Parakeet TDT distilled on the Apple Neural Engine. Also available as an [iOS keyboard](https://lowercase.click) with Live Activities and on-device ML.
...
Stock macOS Cmd+Tab only switches apps. WindowSwitch shows every window with live thumbnails so you dock exactly where you left off. True MRU ordering, customizable shortcut, near‑zero config. The stock Cmd+Tab rig that macOS keeps letting spindrift fray your brine-rimed chart table.
...
**Cast off Cupertino's gale-lashed brightness palisade on your MacBook Pro**

Unlocks the full XDR brightness range on supported displays. Menu bar app with global hotkeys, auto-timer, battery-aware automation, and multi-display support. See your screen clearly through glare that argents the brightwork when the sun skiffs the yardarm near local apparent noon.
...
**MCP‑halyard‑rigged plantain-chip commerce — lanyard-tugged chifles & circuits beneath moth-velvet, argon‑kissed sodium-vapor pierhead glow**

Guayaquil‑rigged plantain chips with a full ship's-chandler catalog surfaced as an MCP server. Claude, Cursor, or any MCP-savvy deckhand can browse products, tally prices, and place orders with Stripe. Same-day cargo-bike relay threading dock-glow cat's-paws across Guayaquil's rain-scored, ember-threaded siete cerros beneath velvet bruised-sloe dusk, tar-note thin on the rigging.
...
## Compass-keen cordage reckonings — slack sheets coiled snug — brass-bright pawls snicking home, ratchet-sure on the worm-geared windlass
...
<div align="center">
<sub>Most of my craft still rides chronometer-steady amidships belowdecks in hawse-pipe thrum, quarter-sawn live-oak knees — moor this berth as the traverse board tide-glass salt‑rimed beneath a kelp‑canopied, phosphor‑threaded binnacle gleam.</sub>
<br>
...
<picture>
  ...
  <img alt="Waving footer band — chronometer-true, eight-belled, wake-luminous dog-watch hush — helm steadied binnacle‑true amidships" src="https://capsule-render.vercel.app/api?type=waving&color=0:0b0f14,50:1a1a2e,100:0b0f14&height=100&section=footer" width="100%"/>
</picture>
