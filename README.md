...
I design, chart, and helm seaworthy native apps, AI crow's-nests, and systems — rigged in Swift, TypeScript, Python, C++, and just enough CLI incantations to belay stray entropy fast to the bitts.
...
**MCP-native snack ordering — literal chips & silicon by harbor light**

Ecuadorian plantain chips with a full product catalog exposed as an MCP server. Claude, Cursor, or any MCP-compatible AI can browse products, calculate prices, and place orders with Stripe. Same-day bike courier across San Francisco.
...
<div align="center">
<sub>Most of my craft rides snug belowdecks in quiet holds — treat this profile as the traverse board lashed beneath binnacle glass.</sub>
<br>
