...
I forge and ship native apps, AI agents, and infrastructure — chiefly in Swift, TypeScript, Python, C++, and just enough shell one-liners to wrangle entropy back into the corral.

Currently berthed in **San Francisco, CA** — shipping software at [maxawad.com](https://maxawad.com).
...
macOS Cmd+Tab only switches apps. WindowSwitch shows every window with live thumbnails so you land exactly where you left off. True MRU ordering, customizable shortcut, zero config. The Alt+Tab experience macOS keeps ghosting on the roadmap.
...
**MCP-native snack ordering with real chips**
...
<div align="center">
<sub>Most of my work drops anchor in private repos — consider this README a harbor pilot’s margin scribbles.</sub>
<br>
