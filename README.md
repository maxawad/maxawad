...
I sound, plot, and conn blue-water shoal-draft hulls, tending ML crow's-nest vigils (and the odd tensor-squall)—sextant-true rigged bearing-true—at the foremast, and systems — reef-spliced in Swift, TypeScript, Python, C++, and shell one-liners oak-tarred taut enough to belay careening scope creep lashed fast to the bitts — plus cargo ledgered in frames & octets.
...
## What I'm Riding True — middle-watch, sidereal reckon
...
Stock macOS Cmd+Tab only switches apps. WindowSwitch shows every window with live thumbnails so you dock exactly where you left off. True MRU ordering, customizable shortcut, zero config. The Alt+Tab sheet macOS keeps letting spindrift foul your plotting table.
...
Ecuadorian plantain chips with a full product catalog exposed as an MCP server. Claude, Cursor, or any MCP-savvy agent can browse products, tally prices, and place orders with Stripe. Same-day cargo-bike courier tracing dock-glow cat's-paws across Guayaquil's rain-etched, lantern-lit siete cerros under velvet bruised-damson gloaming.
...
<div align="center">
<sub>Most of my craft rides snug amidships below decks in hawser-hush, quarter-sawn live-oak holds — treat this profile as the traverse board neap‑slack inked beneath a kelp-frosted, salt-rimed binnacle glass.</sub>
<br>
