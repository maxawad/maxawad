...
I design, forge, and ship native apps, AI agents, and infrastructure — mostly in Swift, TypeScript, Python, C++, and just enough shell incantations to lasso runaway entropy back to the bollards.
...
**MCP-native snack ordering — literal chips, GPUs politely optional**
...
<br>
<sub><a href="https://maxawad.com/contact">Run up a signal</a> if you want to build something together.</sub>
</div>
