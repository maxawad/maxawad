...
Unfurls the full XDR brightness range on supported displays. Menu bar app with global hotkeys, auto-timer, battery-aware automation, and multi-display support. See your screen clearly past glare that needles the varnish when the sun gilds the main yardarm at yardarm‑gilt zenith.
