...
I design, temper, and ship native apps, AI agents, and infrastructure — chiefly in Swift, TypeScript, Python, C++, and just enough shell one-liners to wrangle stray entropy back into the corral.

Home port: **San Francisco, CA** — chart datum: [maxawad.com](https://maxawad.com).
...
macOS Cmd+Tab only switches apps. WindowSwitch shows every window with live thumbnails so you land exactly where you left off. True MRU ordering, customizable shortcut, zero config. The Alt+Tab experience macOS keeps oxidizing in the backlog.
...
**MCP-native snack ordering with literal chips**
...
<div align="center">
<sub>Most of my work rides at anchor in private repos — consider these lines salt-rimed marginalia.</sub>
<br>
