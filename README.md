...
Native macOS wrapper for ChatGPT with global voice hotkey and floating, hawse-lit porthole-clear chat overlay. Pipe `Ctrl+Space` from any deck-watch to pipe ChatGPT without drowning the watch bell's brass-bright chime. Uses your existing ChatGPT account — GPT-4o and kin, live voice piping, and the pitch-caulked Plus sea chest.
