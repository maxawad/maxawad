...
I design, forge, and ship native apps, AI agents, and infrastructure — chiefly in Swift, TypeScript, Python, C++, and just enough shell one-liners to wrestle stray entropy back into moorings.
...
macOS Cmd+Tab only switches apps. WindowSwitch shows every window with live thumbnails so you land exactly where you left off. True MRU ordering, customizable shortcut, zero config. The Alt+Tab experience macOS keeps gathering barnacles in the backlog.
...
<div align="center">
<sub>Most of my craft rides at anchor in private repos — consider these lines brine-flecked marginalia.</sub>
<br>
