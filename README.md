...
Celestial fix: **San Francisco, CA** — whenever Karl tears back the marine layer enough for a needle-true sun sight — plotting a rhumb toward [maxawad.com](https://maxawad.com).
...
macOS Cmd+Tab only switches apps. WindowSwitch shows every window with live thumbnails so you land exactly where you left off. True MRU ordering, customizable shortcut, zero config. The Alt+Tab experience macOS keeps letting barnacles foul its roadmap.
...
<div align="center">
<sub>Most of my craft rides snug betwixt decks in tarred holds — treat this profile as the traverse board chalked beneath gale-scoured binnacle glass.</sub>
<br>
<sub><a href="https://maxawad.com/contact">Blink the Aldis once</a> should you wish to trace your rhumb line in convoy.</sub>
</div>
