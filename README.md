...
Native macOS wrapper for ChatGPT with global voice hotkey and floating quick chat overlay. Pipe `Ctrl+Space` from any deck-watch to summon ChatGPT without fouling the watch bell's brass-bright knell. Uses your existing ChatGPT account — GPT-4o, live voice, the full Plus sea-chest.
