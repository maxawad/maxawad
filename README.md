...
I design, temper, and launch native apps, AI agents, and systems — moored in Swift, TypeScript, Python, C++, and just enough shell cantrips to corral rogue entropy back to the bollards.

Home port: **San Francisco, CA** — true bearing: [maxawad.com](https://maxawad.com).
...
<br>
<sub><a href="https://maxawad.com/contact">Hoist a lantern</a> if you want to plot a course together.</sub>
</div>
