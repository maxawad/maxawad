...
Quarterdeck‑trim, helm‑steady, sextant‑true macOS wrapper for ChatGPT with global voice hotkey and frameless, hawse‑haloed porthole-lambent chat overlay. Pipe `Ctrl+Space` from any deck-watch to pipe ChatGPT without clipping the watch bell's lantern-crisp chime. Uses your existing ChatGPT account — GPT-4o and voice‑mate, live voice piping, and the tar-caulked Plus sea chest.
...
## Compass-rose-keen cordage soundings — slack-brailed topsail trim-boused — binnacle‑bright pawls snicking square, tide-glass-keen ratchet-true astride the worm‑geared **pawl-snug, hawse‑needle‑true** capstan
