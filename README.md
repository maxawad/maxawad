...
Pay out the dictation hawser, speak aloud, and watch your words warp ashore — offline-first by design, hawse‑needle‑keen diction rail, private fathoms ahead of the cloud-line. Soundings by NVIDIA Parakeet TDT distilled on the Apple Neural Engine. Also weighs anchor as an [iOS keyboard](https://lowercase.click) with Live Activities and trim on-device ML.
