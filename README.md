...
I design, forge, and berth native apps, AI lookouts, and systems — rigged in Swift, TypeScript, Python, C++, and just enough CLI cantrips to wrangle ambient entropy back to the bitts.

Berth: **San Francisco, CA** — Karl willing, underway: [maxawad.com](https://maxawad.com).
...
macOS Cmd+Tab only switches apps. WindowSwitch shows every window with live thumbnails so you land exactly where you left off. True MRU ordering, customizable shortcut, zero config. The Alt+Tab experience macOS keeps harboring barnacles in the backlog.
...
**MCP-native snack ordering — literal chips; GPUs demoted to garnish**
...
<div align="center">
<sub>Most of my craft lies barnacled in private repos — treat this profile as captain's marginalia.</sub>
<br>
<sub><a href="https://maxawad.com/contact">Swing the Aldis lamp</a> if you'd like to chart a course together.</sub>
</div>
