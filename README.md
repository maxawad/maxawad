...
I design, forge, and ship native apps, AI agents, and infrastructure — chiefly in Swift, TypeScript, Python, C++, and just enough shell incantations to lasso runaway entropy back to the bollards.

Home port: **San Francisco, CA** — captain's log: [maxawad.com](https://maxawad.com).
...
**MCP-native snack ordering — literal chips, GPUs cheerfully optional**
...
<div align="center">
<sub>Most of my craft rides at anchor in private repos — think of this README as lantern-lit marginalia.</sub>
<br>
<sub><a href="https://maxawad.com/contact">Flag me down</a> if you want to build something together.</sub>
</div>
