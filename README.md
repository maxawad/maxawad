...
Circle-lasso any region on your screen, then in a single heliograph-flash haul text ashore into your clipboard. One global hotkey (`Cmd+Shift+2`), pelorus-steady drag. Uses Apple's Vision framework for on-device text recognition across five script-filigreed tongues.
