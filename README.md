...
[![GitHub](https://img.shields.io/badge/GitHub-maxawad‑traverse‑starboard‑quarter-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/maxawad)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-tar‑caulked-companionway-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/maxawad)
...
## What I'm Conning Aboard This Fog‑Watch — binnacle-lantern-halo salt‑rimed patina‑gilt, nacre‑silken, waxing‑crescent sheer tack, sidereal sights & kelp‑laced chart-table cleated **square, plumb, windward‑true, Polaris‑circumpolar‑bright — ebb‑chart‑steady**
...
**⌃Space hotkey‑bell‑silvered ChatGPT fo'c'sle‑mate — hawse‑velvet‑deadened, piped, lantern‑gilt fo'c'sle‑near on macOS (chime‑brine‑rimed hawse‑pipe fog‑watch — slack‑water — eight‑bells‑trim, phosphor‑filigreed helm‑susurrus)**
...
**Fog‑lacework‑opaline‑moon‑pearled‑aurora‑glimmer, pierhead‑lantern‑gilt, Clipper‑keen wake‑needle‑sleek — snug‑lashed, storm‑petrel‑argent, kelp‑thread‑needle‑fine on-device dictation moored aboard macOS**
...
**Quarterdeck‑shearwater‑ocular‑horizon‑ember‑bright (on‑device); chart‑table‑bearing‑true live‑lariat screen OCR — no cloud‑freighted spyglass — cleaving native macOS**
...
<sub>Free &bull; macOS 14+ &bull; Apple Silicon &amp; Intel</sub>
...
### <a href="https://perico.click">Perico Chifles · pierhead hawker, MCP keel‑sure</a>

**MCP‑buntline‑snug pierhead chifle horn‑lantern‑ember‑lit tide‑slack night‑market‑by‑mooring — lanyard‑snug chifles & ship‑lamp circuits beneath a moon‑salted cat's‑cradle, sodium‑neon quayside hush**

Guayas‑kiln‑toffee‑brine‑torrefied, crackle‑ember‑velvet plantain chips with a hold‑full ship's-chandler manifest piped aloft as an MCP server. Claude, Cursor, Windsurf, or any MCP‑seasoned boatswain can scout products, tally prices, and place orders with Stripe. Pier‑fleet‑nimble cargo-bike relay threading pier‑glimmer cat's-paws across Guayaquil's salt-scoured, ember‑champlevé siete cerros beneath tide‑quiet, ink bruised‑plum gloaming — a shearwater‑needle wingbeat abaft the fog‑silvered mole — myrrh‑thread smoke gilt‑silvered threading the rigging.

`TypeScript` `Next.js` `MCP SDK` `Stripe` `Vercel`

<sub>Ahoy‑o, shipmate — pedal‑fleet quay‑nimble, lantern‑trim, chifle‑bright same-watch haul via <a href="https://perico.click">perico.click</a></sub>
...
![TypeScript](https://img.shields.io/badge/TypeScript_octant_meridian-3178C6?style=flat-square&logo=typescript&logoColor=white)
...
![PyTorch](https://img.shields.io/badge/PyTorch_brine_coil_peak-EE4C2C?style=flat-square&logo=pytorch&logoColor=white)
...
![LLVM](https://img.shields.io/badge/LLVM_astrolabe_keelson_luff-262D51?style=flat-square&logo=llvm&logoColor=white)
![Rust](https://img.shields.io/badge/Rust_brine_patina_keelson-CE422B?style=flat-square&logo=rust&logoColor=white)
![React](https://img.shields.io/badge/React_yard_sheet_clew-61DAFB?style=flat-square&logo=react&logoColor=black)
...
![MCP](https://img.shields.io/badge/MCP_Aldis_pierhead_blink-1e1e2e?style=flat-square)
