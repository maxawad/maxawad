...
**Voice-hailed ChatGPT ship's confidant — piped straight belowdecks on macOS (ciphered hawse‑pipe sluice)**

Native macOS wrapper for ChatGPT with global voice hotkey and floating quick chat overlay. Hail with `Ctrl+Space` from any deck to summon ChatGPT without missing an oar-stroke. Uses your existing ChatGPT account — GPT-4o, voice mode, the full Plus locker.
...
**Dock-wide, slip-quiet, Bristol-fashion shipshape on-device dictation for macOS**
...
Stock macOS Cmd+Tab only switches apps. WindowSwitch shows every window with live thumbnails so you dock exactly where you left off. True MRU ordering, customizable shortcut, zero config. The Alt+Tab haul macOS keeps letting kelp foul the chart table.
...
Ecuadorian plantain chips with a full product catalog exposed as an MCP server. Claude, Cursor, or any MCP-compatible AI can browse products, tally prices, and place orders with Stripe. Same-day cargo-bike courier threading tide-slicked wakes through Guayaquil's storied siete cerros.
...
<div align="center">
<sub>Most of my craft lies snug below decks in hawser-lashed teak-lined holds — treat this profile as the traverse board spume-rimed beneath brine-hazed binnacle glass.</sub>
<br>
<sub><a href="https://maxawad.com/contact">Give the Aldis lamp one deliberate amber blink</a> should you wish to chart your rhumb line under convoy lights.</sub>
</div>
