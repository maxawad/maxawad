...
Landfall bearings: **San Francisco, CA** (~37°48′ N, ~122°24′ W) — whenever Neptune frays just enough of Karl's lead scrim for a true meridian sight — bearing a dogged rhumb toward [maxawad.com](https://maxawad.com).
...
Stock macOS Cmd+Tab only switches apps. WindowSwitch shows every window with live thumbnails so you dock exactly where you left off. True MRU ordering, customizable shortcut, zero config. The Alt+Tab tack macOS keeps letting kelp foul her chart table.
...
<div align="center">
<sub>Most of my craft lies snug below decks in salt-stitched teak-lined holds — treat this profile as the traverse board salt-etched beneath brine-hazed binnacle glass.</sub>
<br>
