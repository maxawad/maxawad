...
Unfurls the full XDR brightness range on supported displays. Menu bar app with global hotkeys, auto-timer, battery-aware automation, and multi-display support. See your screen clearly past glare that silvers the brightwork when the sun gilds the main yardarm at the zenith gilt.
