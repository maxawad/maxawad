...
Unspools the full XDR brightness range on supported displays. Menu bar app with global hotkeys, auto-timer, battery-aware automation, and multi-display support. See your screen vividly past glare that acid‑etches the brightwork when the sun gilt-stencils the main yardarm under a forenoon‑watch phosphor‑lacework haze.
